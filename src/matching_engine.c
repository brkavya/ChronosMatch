...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "src/matching_engine.pyx"
        ]
    },
    "module_name": "matching_engine"
}
END: Cython Metadata */
...
#define __PYX_HAVE__matching_engine
#define __PYX_HAVE_API__matching_engine
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "matching_engine" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "matching_engine"
extern int __pyx_module_is_main_matching_engine;
int __pyx_module_is_main_matching_engine = 0;

/* Implementation of "matching_engine" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_15matching_engine_match_order_c(CYTHON_UNUSED PyObject *__pyx_self, unsigned PY_LONG_LONG __pyx_v_order_id, double __pyx_v_price, unsigned int __pyx_v_quantity, char __pyx_v_side, PyObject *__pyx_v_resting_prices, PyObject *__pyx_v_resting_book); /* proto */
...
#define __pyx_kp_u_src_matching_engine_pyx __pyx_string_tab[3]
...
#define __pyx_n_u_best_price __pyx_string_tab[14]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[15]
#define __pyx_n_u_items __pyx_string_tab[16]
#define __pyx_n_u_maker_order __pyx_string_tab[17]
#define __pyx_n_u_match_order_c __pyx_string_tab[18]
#define __pyx_n_u_matched_qty __pyx_string_tab[19]
#define __pyx_n_u_matching_engine __pyx_string_tab[20]
#define __pyx_n_u_order_id __pyx_string_tab[21]
#define __pyx_n_u_pop __pyx_string_tab[22]
#define __pyx_n_u_price __pyx_string_tab[23]
#define __pyx_n_u_quantity __pyx_string_tab[24]
#define __pyx_n_u_queue __pyx_string_tab[25]
#define __pyx_n_u_remaining_qty __pyx_string_tab[26]
#define __pyx_n_u_resting_book __pyx_string_tab[27]
#define __pyx_n_u_resting_prices __pyx_string_tab[28]
#define __pyx_n_u_setdefault __pyx_string_tab[29]
#define __pyx_n_u_side __pyx_string_tab[30]
#define __pyx_n_u_trades __pyx_string_tab[31]
#define __pyx_n_u_values __pyx_string_tab[32]
#define __pyx_n_b_B __pyx_string_tab[33]
#define __pyx_n_b_S __pyx_string_tab[34]
#define __pyx_kp_b_iso88591_a_A_q_uCt1A_nBb_Cq_8_D_asRUUV_q __pyx_string_tab[35]
...
/* Python wrapper */
static PyObject *__pyx_pw_15matching_engine_1match_order_c(PyObject *__pyx_self, 
#if CYTHON_VECTORCALL
...
PyDoc_STRVAR(__pyx_doc_15matching_engine_match_order_c, "\n    Cython-accelerated order matching routine using C-level data types.\n    ");
static PyMethodDef __pyx_mdef_15matching_engine_1match_order_c = {"match_order_c", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_15matching_engine_1match_order_c, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_15matching_engine_match_order_c};
static PyObject *__pyx_pw_15matching_engine_1match_order_c(PyObject *__pyx_self, 
#if CYTHON_VECTORCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  unsigned PY_LONG_LONG __pyx_v_order_id;
  double __pyx_v_price;
  unsigned int __pyx_v_quantity;
  char __pyx_v_side;
  PyObject *__pyx_v_resting_prices = 0;
  PyObject *__pyx_v_resting_book = 0;
  #if !CYTHON_VECTORCALL
  ...
  __Pyx_RefNannySetupContext("match_order_c (wrapper)", 0);
  #if !CYTHON_VECTORCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_order_id,&__pyx_mstate_global->__pyx_n_u_price,&__pyx_mstate_global->__pyx_n_u_quantity,&__pyx_mstate_global->__pyx_n_u_side,&__pyx_mstate_global->__pyx_n_u_resting_prices,&__pyx_mstate_global->__pyx_n_u_resting_book,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "match_order_c", 0) < (0)) __PYX_ERR(0, 4, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 6; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("match_order_c", 1, 6, 6, i); __PYX_ERR(0, 4, __pyx_L3_error) }
      }
    ...
    __pyx_v_order_id = __Pyx_PyLong_As_unsigned_PY_LONG_LONG(values[0]); if (unlikely((__pyx_v_order_id == (unsigned PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_price = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_price == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_quantity = __Pyx_PyLong_As_unsigned_int(values[2]); if (unlikely((__pyx_v_quantity == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_side = __Pyx_PyLong_As_char(values[3]); if (unlikely((__pyx_v_side == (char)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_resting_prices = ((PyObject*)values[4]);
    __pyx_v_resting_book = ((PyObject*)values[5]);
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("match_order_c", 1, 6, 6, __pyx_nargs); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("matching_engine.match_order_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_resting_prices), (&PyList_Type), 1, "resting_prices", 1))) __PYX_ERR(0, 9, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_resting_book), (&PyDict_Type), 1, "resting_book", 1))) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_r = __pyx_pf_15matching_engine_match_order_c(__pyx_self, __pyx_v_order_id, __pyx_v_price, __pyx_v_quantity, __pyx_v_side, __pyx_v_resting_prices, __pyx_v_resting_book);
...
static PyObject *__pyx_pf_15matching_engine_match_order_c(CYTHON_UNUSED PyObject *__pyx_self, unsigned PY_LONG_LONG __pyx_v_order_id, double __pyx_v_price, unsigned int __pyx_v_quantity, char __pyx_v_side, PyObject *__pyx_v_resting_prices, PyObject *__pyx_v_resting_book) {
  unsigned int __pyx_v_remaining_qty;
  unsigned int __pyx_v_matched_qty;
  double __pyx_v_best_price;
  PyObject *__pyx_v_trades = 0;
  PyObject *__pyx_v_queue = 0;
  PyObject *__pyx_v_maker_order = 0;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("match_order_c", 0);

  /* "matching_engine.pyx":15
 *     Cython-accelerated order matching routine using C-level data types.
 *     """
...
*/
  __pyx_v_remaining_qty = __pyx_v_quantity;

  /* "matching_engine.pyx":16
 *     """
 *     cdef unsigned int remaining_qty = quantity
 *     cdef unsigned int matched_qty = 0             # <<<<<<<<<<<<<<
 *     cdef double best_price
 *     cdef list trades = []
*/
  __pyx_v_matched_qty = 0;

  /* "matching_engine.pyx":18
 *     cdef unsigned int matched_qty = 0
 *     cdef double best_price
 *     cdef list trades = []             # <<<<<<<<<<<<<<
 *     cdef list queue
...
*/
  __pyx_t_2 = __Pyx_GetItemInt_Bytes(__pyx_mstate_global->__pyx_n_b_B, 0, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_SharedReference); if (unlikely(__pyx_t_2 == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_t_3 = (__pyx_v_side == __pyx_t_2);


  if (__pyx_t_3) {


    /* "matching_engine.pyx":23
 * 
 *     if side == b'B'[0]:
 *         while remaining_qty > 0 and len(resting_prices) > 0 and resting_prices[0] <= price:             # <<<<<<<<<<<<<<
 *             best_price = resting_prices[0]
...
*/
    while (1) {
      __pyx_t_4 = (__pyx_v_remaining_qty > 0);
      ...
      if (unlikely(__pyx_v_resting_prices == Py_None)) {
        PyErr_SetString(PyExc_TypeError, "object of type \047NoneType\047 has no len()");
        __PYX_ERR(0, 23, __pyx_L1_error)
      }
      __pyx_t_5 = __Pyx_PyList_GET_SIZE(__pyx_v_resting_prices); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 23, __pyx_L1_error)
      ...
      __pyx_t_1 = __Pyx_GetItemInt_List(__pyx_v_resting_prices, 0, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_FunctionArgument); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_6 = PyFloat_FromDouble(__pyx_v_price); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 23, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_4 = __Pyx_PyObject_CompareBoolLe_object_float(__pyx_t_1, __pyx_t_6, Py_LE); if (unlikely((__pyx_t_4 < 0))) __PYX_ERR(0, 23, __pyx_L1_error)
...
*/
      ...
      __pyx_t_6 = __Pyx_GetItemInt_List(__pyx_v_resting_prices, 0, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_FunctionArgument); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 24, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_7 = __Pyx_PyFloat_AsDouble(__pyx_t_6); if (unlikely((__pyx_t_7 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_v_best_price = __pyx_t_7;

      /* "matching_engine.pyx":25
 *         while remaining_qty > 0 and len(resting_prices) > 0 and resting_prices[0] <= price:
 *             best_price = resting_prices[0]
 *             queue = resting_book[best_price]             # <<<<<<<<<<<<<<
 * 
...
*/
      if (unlikely(__pyx_v_resting_book == Py_None)) {
        PyErr_SetString(PyExc_TypeError, "\047NoneType\047 object is not subscriptable");
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
      __pyx_t_6 = PyFloat_FromDouble(__pyx_v_best_price); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 25, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_1 = __Pyx_PyDict_GetItem(__pyx_v_resting_book, __pyx_t_6); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      ...
      __Pyx_XDECREF_SET(__pyx_v_queue, ((PyObject*)__pyx_t_1));
      __pyx_t_1 = 0;

      /* "matching_engine.pyx":27
 *             queue = resting_book[best_price]
 * 
 *             while remaining_qty > 0 and len(queue) > 0:             # <<<<<<<<<<<<<<
 *                 maker_order = queue[0]
...
*/
      while (1) {
        ...
        __pyx_t_5 = __Pyx_PyList_GET_SIZE(__pyx_v_queue); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 27, __pyx_L1_error)
        __pyx_t_4 = (__pyx_t_5 > 0);
...
*/
        ...
        __pyx_t_1 = __Pyx_GetItemInt_List(__pyx_v_queue, 0, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        ...
        __Pyx_XDECREF_SET(__pyx_v_maker_order, ((PyObject*)__pyx_t_1));
        __pyx_t_1 = 0;

        /* "matching_engine.pyx":29
 *             while remaining_qty > 0 and len(queue) > 0:
 *                 maker_order = queue[0]
 *                 matched_qty = remaining_qty if remaining_qty < maker_order[1] else maker_order[1]             # <<<<<<<<<<<<<<
 * 
...
*/
        __pyx_t_1 = __Pyx_PyLong_From_unsigned_int(__pyx_v_remaining_qty); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        if (unlikely(__pyx_v_maker_order == Py_None)) {
          PyErr_SetString(PyExc_TypeError, "\047NoneType\047 object is not subscriptable");
          __PYX_ERR(0, 29, __pyx_L1_error)
        }
        __pyx_t_6 = __Pyx_GetItemInt_List(__pyx_v_maker_order, 1, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 29, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_t_3 = __Pyx_PyObject_CompareBoolLt_int_object(__pyx_t_1, __pyx_t_6, Py_LT); if (unlikely((__pyx_t_3 < 0))) __PYX_ERR(0, 29, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        if (__pyx_t_3) {

          __pyx_t_8 = __pyx_v_remaining_qty;
        } else {
          if (unlikely(__pyx_v_maker_order == Py_None)) {
            PyErr_SetString(PyExc_TypeError, "\047NoneType\047 object is not subscriptable");
            __PYX_ERR(0, 29, __pyx_L1_error)
          ...
          __pyx_t_6 = __Pyx_GetItemInt_List(__pyx_v_maker_order, 1, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 29, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __pyx_t_9 = __Pyx_PyLong_As_unsigned_int(__pyx_t_6); if (unlikely((__pyx_t_9 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 29, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
          __pyx_t_8 = __pyx_t_9;
        }

        __pyx_v_matched_qty = __pyx_t_8;

        /* "matching_engine.pyx":31
 *                 matched_qty = remaining_qty if remaining_qty < maker_order[1] else maker_order[1]
 * 
 *                 trades.append((maker_order[0], order_id, best_price, matched_qty))             # <<<<<<<<<<<<<<
...
*/
        ...
        __pyx_t_6 = __Pyx_GetItemInt_List(__pyx_v_maker_order, 0, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_t_1 = __Pyx_PyLong_From_unsigned_PY_LONG_LONG(__pyx_v_order_id); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_10 = PyFloat_FromDouble(__pyx_v_best_price); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_10);
        __pyx_t_11 = __Pyx_PyLong_From_unsigned_int(__pyx_v_matched_qty); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_12 = PyTuple_New(4); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __Pyx_GIVEREF(__pyx_t_6);
        if (__Pyx_PyTuple_SET_ITEM(__pyx_t_12, 0, __pyx_t_6) != (0)) __PYX_ERR(0, 31, __pyx_L1_error);
        __Pyx_GIVEREF(__pyx_t_1);
        if (__Pyx_PyTuple_SET_ITEM(__pyx_t_12, 1, __pyx_t_1) != (0)) __PYX_ERR(0, 31, __pyx_L1_error);
        __Pyx_GIVEREF(__pyx_t_10);
        if (__Pyx_PyTuple_SET_ITEM(__pyx_t_12, 2, __pyx_t_10) != (0)) __PYX_ERR(0, 31, __pyx_L1_error);
        __Pyx_GIVEREF(__pyx_t_11);
        if (__Pyx_PyTuple_SET_ITEM(__pyx_t_12, 3, __pyx_t_11) != (0)) __PYX_ERR(0, 31, __pyx_L1_error);
        __pyx_t_6 = 0;
        __pyx_t_1 = 0;
        __pyx_t_10 = 0;
        __pyx_t_11 = 0;
        __pyx_t_13 = __Pyx_PyList_Append(__pyx_v_trades, __pyx_t_12); if (unlikely(__pyx_t_13 == ((int)-1))) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;


        /* "matching_engine.pyx":32
 * 
 *                 trades.append((maker_order[0], order_id, best_price, matched_qty))
 *                 remaining_qty -= matched_qty             # <<<<<<<<<<<<<<
 *                 maker_order[1] -= matched_qty
 * 
*/
        __pyx_v_remaining_qty = (__pyx_v_remaining_qty - __pyx_v_matched_qty);

        /* "matching_engine.pyx":33
 *                 trades.append((maker_order[0], order_id, best_price, matched_qty))
 *                 remaining_qty -= matched_qty
 *                 maker_order[1] -= matched_qty             # <<<<<<<<<<<<<<
 * 
...
*/
        ...
        __Pyx_INCREF(__pyx_v_maker_order);
        __pyx_t_14 = __pyx_v_maker_order;
        ...
        __pyx_t_12 = __Pyx_GetItemInt_List(__pyx_t_14, __pyx_t_5, Py_ssize_t, 1, PyLong_FromSsize_t, 1, 1, 1, __Pyx_ReferenceSharing_SharedReference); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 33, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __pyx_t_11 = __Pyx_PyLong_From_unsigned_int(__pyx_v_matched_qty); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 33, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_10 = __Pyx_PyNumber_InPlaceSubtract_object_int(__pyx_t_12, __pyx_t_11); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 33, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_10);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
        ...
        if (unlikely((__Pyx_SetItemInt(__pyx_t_14, __pyx_t_5, __pyx_t_10, Py_ssize_t, 1, PyLong_FromSsize_t, 1, 1, 1, __Pyx_ReferenceSharing_SharedReference) < 0))) __PYX_ERR(0, 33, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;

        /* "matching_engine.pyx":35
 *                 maker_order[1] -= matched_qty
 * 
 *                 if maker_order[1] == 0:             # <<<<<<<<<<<<<<
 *                     queue.pop(0)
...
*/
        ...
        __pyx_t_10 = __Pyx_GetItemInt_List(__pyx_v_maker_order, 1, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 35, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_10);
        __pyx_t_3 = (__Pyx_PyLong_BoolEqObjC(__pyx_t_10, __pyx_mstate_global->__pyx_int_0, 0, 0)); if (unlikely((__pyx_t_3 < 0))) __PYX_ERR(0, 35, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
        if (__pyx_t_3) {


          /* "matching_engine.pyx":36
 * 
 *                 if maker_order[1] == 0:
 *                     queue.pop(0)             # <<<<<<<<<<<<<<
 * 
...
*/
          ...
          __pyx_t_10 = __Pyx_PyList_PopIndex(__pyx_v_queue, __pyx_mstate_global->__pyx_int_0, 0, 1, Py_ssize_t, PyLong_FromSsize_t); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 36, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_10);
          __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
...
*/
      ...
      __pyx_t_5 = __Pyx_PyList_GET_SIZE(__pyx_v_queue); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 38, __pyx_L1_error)
...
*/
        ...
        __pyx_t_10 = PyFloat_FromDouble(__pyx_v_best_price); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 39, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_10);
        if (unlikely((PyDict_DelItem(__pyx_v_resting_book, __pyx_t_10) < 0))) __PYX_ERR(0, 39, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;

        /* "matching_engine.pyx":40
 *             if len(queue) == 0:
 *                 del resting_book[best_price]
 *                 resting_prices.pop(0)             # <<<<<<<<<<<<<<
 * 
...
*/
        ...
        __pyx_t_10 = __Pyx_PyList_PopIndex(__pyx_v_resting_prices, __pyx_mstate_global->__pyx_int_0, 0, 1, Py_ssize_t, PyLong_FromSsize_t); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 40, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_10);
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
 ...
 *             best_price = resting_prices[0]
*/
  __pyx_t_2 = __Pyx_GetItemInt_Bytes(__pyx_mstate_global->__pyx_n_b_S, 0, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_SharedReference); if (unlikely(__pyx_t_2 == -1)) __PYX_ERR(0, 42, __pyx_L1_error)
  __pyx_t_3 = (__pyx_v_side == __pyx_t_2);
...
*/
    while (1) {
      ...
      __pyx_t_5 = __Pyx_PyList_GET_SIZE(__pyx_v_resting_prices); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 43, __pyx_L1_error)
      __pyx_t_4 = (__pyx_t_5 > 0);
      ...
      __pyx_t_10 = __Pyx_GetItemInt_List(__pyx_v_resting_prices, 0, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_FunctionArgument); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 43, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_11 = PyFloat_FromDouble(__pyx_v_price); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 43, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_4 = __Pyx_PyObject_CompareBoolGe_object_float(__pyx_t_10, __pyx_t_11, Py_GE); if (unlikely((__pyx_t_4 < 0))) __PYX_ERR(0, 43, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
...
*/
      ...
      __pyx_t_11 = __Pyx_GetItemInt_List(__pyx_v_resting_prices, 0, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_FunctionArgument); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 44, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_7 = __Pyx_PyFloat_AsDouble(__pyx_t_11); if (unlikely((__pyx_t_7 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_v_best_price = __pyx_t_7;

      /* "matching_engine.pyx":45
 *         while remaining_qty > 0 and len(resting_prices) > 0 and resting_prices[0] >= price:
 *             best_price = resting_prices[0]
 *             queue = resting_book[best_price]             # <<<<<<<<<<<<<<
 * 
...
*/
      ...
      __pyx_t_11 = PyFloat_FromDouble(__pyx_v_best_price); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 45, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_10 = __Pyx_PyDict_GetItem(__pyx_v_resting_book, __pyx_t_11); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 45, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      if (!(likely(PyList_CheckExact(__pyx_t_10))||((__pyx_t_10) == Py_None) || __Pyx_RaiseUnexpectedTypeError("list", __pyx_t_10))) __PYX_ERR(0, 45, __pyx_L1_error)
      __Pyx_XDECREF_SET(__pyx_v_queue, ((PyObject*)__pyx_t_10));
      __pyx_t_10 = 0;

      /* "matching_engine.pyx":47
 *             queue = resting_book[best_price]
 * 
 *             while remaining_qty > 0 and len(queue) > 0:             # <<<<<<<<<<<<<<
 *                 maker_order = queue[0]
...
*/
      while (1) {
        ...
        __pyx_t_5 = __Pyx_PyList_GET_SIZE(__pyx_v_queue); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 47, __pyx_L1_error)
        __pyx_t_4 = (__pyx_t_5 > 0);
...
*/
        ...
        __pyx_t_10 = __Pyx_GetItemInt_List(__pyx_v_queue, 0, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 48, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_10);
        if (!(likely(PyList_CheckExact(__pyx_t_10))||((__pyx_t_10) == Py_None) || __Pyx_RaiseUnexpectedTypeError("list", __pyx_t_10))) __PYX_ERR(0, 48, __pyx_L1_error)
        __Pyx_XDECREF_SET(__pyx_v_maker_order, ((PyObject*)__pyx_t_10));
        __pyx_t_10 = 0;

        /* "matching_engine.pyx":49
 *             while remaining_qty > 0 and len(queue) > 0:
 *                 maker_order = queue[0]
 *                 matched_qty = remaining_qty if remaining_qty < maker_order[1] else maker_order[1]             # <<<<<<<<<<<<<<
 * 
 *                 trades.append((maker_order[0], order_id, best_price, matched_qty))
*/
        __pyx_t_10 = __Pyx_PyLong_From_unsigned_int(__pyx_v_remaining_qty); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_10);
        if (unlikely(__pyx_v_maker_order == Py_None)) {
          PyErr_SetString(PyExc_TypeError, "\047NoneType\047 object is not subscriptable");
          __PYX_ERR(0, 49, __pyx_L1_error)
        }
        __pyx_t_11 = __Pyx_GetItemInt_List(__pyx_v_maker_order, 1, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_3 = __Pyx_PyObject_CompareBoolLt_int_object(__pyx_t_10, __pyx_t_11, Py_LT); if (unlikely((__pyx_t_3 < 0))) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        if (__pyx_t_3) {
          ...
          __pyx_t_11 = __Pyx_GetItemInt_List(__pyx_v_maker_order, 1, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 49, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_11);
          __pyx_t_9 = __Pyx_PyLong_As_unsigned_int(__pyx_t_11); if (unlikely((__pyx_t_9 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
          __pyx_t_8 = __pyx_t_9;
        }
...
*/
        ...
        __pyx_t_11 = __Pyx_GetItemInt_List(__pyx_v_maker_order, 0, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_10 = __Pyx_PyLong_From_unsigned_PY_LONG_LONG(__pyx_v_order_id); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_10);
        __pyx_t_12 = PyFloat_FromDouble(__pyx_v_best_price); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __pyx_t_1 = __Pyx_PyLong_From_unsigned_int(__pyx_v_matched_qty); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_6 = PyTuple_New(4); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_GIVEREF(__pyx_t_11);
        if (__Pyx_PyTuple_SET_ITEM(__pyx_t_6, 0, __pyx_t_11) != (0)) __PYX_ERR(0, 51, __pyx_L1_error);
        __Pyx_GIVEREF(__pyx_t_10);
        if (__Pyx_PyTuple_SET_ITEM(__pyx_t_6, 1, __pyx_t_10) != (0)) __PYX_ERR(0, 51, __pyx_L1_error);
        __Pyx_GIVEREF(__pyx_t_12);
        if (__Pyx_PyTuple_SET_ITEM(__pyx_t_6, 2, __pyx_t_12) != (0)) __PYX_ERR(0, 51, __pyx_L1_error);
        __Pyx_GIVEREF(__pyx_t_1);
        if (__Pyx_PyTuple_SET_ITEM(__pyx_t_6, 3, __pyx_t_1) != (0)) __PYX_ERR(0, 51, __pyx_L1_error);
        __pyx_t_11 = 0;
        __pyx_t_10 = 0;
        __pyx_t_12 = 0;
        __pyx_t_1 = 0;
        __pyx_t_13 = __Pyx_PyList_Append(__pyx_v_trades, __pyx_t_6); if (unlikely(__pyx_t_13 == ((int)-1))) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;


        /* "matching_engine.pyx":52
 * 
 *                 trades.append((maker_order[0], order_id, best_price, matched_qty))
 *                 remaining_qty -= matched_qty             # <<<<<<<<<<<<<<
 *                 maker_order[1] -= matched_qty
...
*/
        ...
        __pyx_t_6 = __Pyx_GetItemInt_List(__pyx_t_14, __pyx_t_5, Py_ssize_t, 1, PyLong_FromSsize_t, 1, 1, 1, __Pyx_ReferenceSharing_SharedReference); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 53, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_t_1 = __Pyx_PyLong_From_unsigned_int(__pyx_v_matched_qty); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_12 = __Pyx_PyNumber_InPlaceSubtract_object_int(__pyx_t_6, __pyx_t_1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 53, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        if (unlikely(__pyx_t_14 == Py_None)) {
        ...
        if (unlikely((__Pyx_SetItemInt(__pyx_t_14, __pyx_t_5, __pyx_t_12, Py_ssize_t, 1, PyLong_FromSsize_t, 1, 1, 1, __Pyx_ReferenceSharing_SharedReference) < 0))) __PYX_ERR(0, 53, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;

        /* "matching_engine.pyx":55
 *                 maker_order[1] -= matched_qty
 * 
 *                 if maker_order[1] == 0:             # <<<<<<<<<<<<<<
 *                     queue.pop(0)
...
*/
        ...
        __pyx_t_12 = __Pyx_GetItemInt_List(__pyx_v_maker_order, 1, long, 1, __Pyx_PyLong_From_long, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __pyx_t_3 = (__Pyx_PyLong_BoolEqObjC(__pyx_t_12, __pyx_mstate_global->__pyx_int_0, 0, 0)); if (unlikely((__pyx_t_3 < 0))) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
        if (__pyx_t_3) {


          /* "matching_engine.pyx":56
 * 
 *                 if maker_order[1] == 0:
 *                     queue.pop(0)             # <<<<<<<<<<<<<<
 * 
...
*/
          ...
          __pyx_t_12 = __Pyx_PyList_PopIndex(__pyx_v_queue, __pyx_mstate_global->__pyx_int_0, 0, 1, Py_ssize_t, PyLong_FromSsize_t); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 56, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_12);
          __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
...
*/
      ...
      __pyx_t_5 = __Pyx_PyList_GET_SIZE(__pyx_v_queue); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 58, __pyx_L1_error)
      __pyx_t_3 = (__pyx_t_5 == 0);
...
*/
        ...
        __pyx_t_12 = PyFloat_FromDouble(__pyx_v_best_price); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 59, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        if (unlikely((PyDict_DelItem(__pyx_v_resting_book, __pyx_t_12) < 0))) __PYX_ERR(0, 59, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;

        /* "matching_engine.pyx":60
 *             if len(queue) == 0:
 *                 del resting_book[best_price]
 *                 resting_prices.pop(0)             # <<<<<<<<<<<<<<
 * 
...
*/
        ...
        __pyx_t_12 = __Pyx_PyList_PopIndex(__pyx_v_resting_prices, __pyx_mstate_global->__pyx_int_0, 0, 1, Py_ssize_t, PyLong_FromSsize_t); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 60, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
...
*/
  ...
  /* "matching_engine.pyx":62
 *                 resting_prices.pop(0)
 * 
 *     return trades, remaining_qty             # <<<<<<<<<<<<<<
*/
  __pyx_t_12 = __Pyx_PyLong_From_unsigned_int(__pyx_v_remaining_qty); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  ...
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_v_trades) != (0)) __PYX_ERR(0, 62, __pyx_L1_error);
  __Pyx_GIVEREF(__pyx_t_12);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_1, 1, __pyx_t_12) != (0)) __PYX_ERR(0, 62, __pyx_L1_error);
  __pyx_t_12 = 0;
  {
    PyObject *__pyx_temp;
    {
...
*/
  ...
  __Pyx_XDECREF(__pyx_v_maker_order);
...
static int __pyx_pymod_exec_matching_engine(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_matching_engine},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_matching_engine(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_matching_engine(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_matching_engine(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'matching_engine' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "matching_engine" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_matching_engine", 0);
  ...
  if (__pyx_module_is_main_matching_engine) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "matching_engine")) {
      if (unlikely((PyDict_SetItemString(modules, "matching_engine", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     double price,
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_15matching_engine_1match_order_c, 0, __pyx_mstate_global->__pyx_n_u_match_order_c, NULL, __pyx_mstate_global->__pyx_n_u_matching_engine, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_match_order_c, __pyx_t_2) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "matching_engine.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init matching_engine", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init matching_engine");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } str_length_index[] = {{1},{179},{8},{23},{20},{12},{8},{8},{10},{8},{12},{8},{13},{18},{10},{18},{5},{11},{13},{11},{15},{8},{3},{5},{8},{5},{13},{12},{14},{10},{4},{6},{6}};
    const struct { const unsigned int length: 9; } bytes_length_index[] = {{1},{1},{442}};
    #ifndef CYTHON_COMPRESS_STRINGS
      #define CYTHON_COMPRESS_STRINGS 90
    #endif
    #if (CYTHON_COMPRESS_STRINGS) == 1 /* compression: zlib (580 bytes) */
static const char cstring[] = "x\332\335P\277O\0331\024\006\032$\252F4\264\021\025j\205\034\250D\227\006\245Bj\244\016\025?JU\251BI\020\035q}\366K\342r\261\223\263\017qE\252\0303\336\350\321\343\215\214\031\0313\336xc\376\004\376\204\372\016\250\252\376\t\365\340\367=\373\373\336\373\336\373x$5 \335\047\032\355G\272/\005\342\n1\360\271\007\001\321\340GH\351\200S\rAN\022\250\365\251\365v\247\271\203\210`(\200\037@\265B*\364\250O\224\002\205d\027y!\3675\027HGCPu\364\245\213\"\031\"\001\300\220\226h\350x\177\013t\037\004R\240s\200\266\210\020R\023\315\245\300N\316Eo\0131\036\270&\374\034r\365!\361\025\324\tc\330\361@\005t{@4\355;\"\006\321\343\002\352\303\350\002\343\226\273Z\321\201\263\215\217\340Bw\240\213\361}i\300\356tCA\3638 \\\024Q\262\320/~\004\031\024q\024\022\377\001\273F\332\005\2560\225\201\014\335l@T$(\227\365?\017\312\313IC\267)\240\276\313\261+\254\003B\301#\364\214k\030\250\0019\203\000\313\200APx\276\203\230\026\t0<\322\321?\263\334\0218\033\312aQ\330y\022\232\353h\024B\010\001\344\346s\262\023\006\256y\016=)\317\036p!q+\326\014\272$\364\265\342\014\234#\006\352\234\370!\250\275\343\253\371\333\325\271\305-K\262\322k\273;+\275\210G\267Ks\213KW\341x\177\254\343F\274\233--\217\205\3313\236-\331};J\3374\047\013\223\215\311\301\315\362\224LU\3329IO\276e\3455\263nG\311|V\256\306_\355\274]\231\225\237\305u\273`7\354A\362(i$\237\257\337]\267\263\312\272\001\333\260\273\016\244\353\333\311\257Igr9\255M\233\351\361iz\212S\374}VY\215{\246c.\223Z\262\223\374\234\274\272q\242\232]\311*/M\303\034\332\332\254\362<\376`\210Qv\323\266\263\352\232\251\232\266!\263\362\323\261\212k\361{\263i\234\340\336C\336\216\331\232m\314\036/\217i\\\215\3331\371\037\246)=\0317\343\306o}\371|\311";
    ...
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) > 0 && (CYTHON_COMPRESS_STRINGS) <= 90 /* compression: lzss (714 bytes) */
static const char cstring[] = "\377?Note th\377at Cytho\377n is del\377iberatel\377y strict\373er!\001n PEP\377-484 and\377 rejects\377 subclas\377ses of b\377uiltin t\377ypes. If\377 you nee?d to p%\000%\t\377then set\376\200\000e \047anno\177tation_<\000\377ing\047 dir\366b\000iv\242\000o Fa\377lse.add_\376%\000esrc/ma\367tch&\000_eng\377ine.pyx_\273_P\002\000PyD\264\000_\377NextRef_\375_T\004e____f\367unc\004\001main\336\003\002odul\025\002na\275m\035\002qual\004\005t\367est3\000is_c\357orou\331\000eas\277yncio.\010\006sub!\001p\247 ecl\205\000\375_V\000traceb\377ackitems\377maker_orgder\257\002\005\003_c\274\002?ed_qty\275\014\047\002?_idpopT\002\221\000\377ntityque\217uere\271\001\365\0016\000r<\237\000\200!book\004\005\207\002\376\221@tdefaul\337tside\217\000de\377svaluesB\377S\200\001\360\026\000\005\047\377\240a\330\004$\240A\340\377\004\027\220q\360\010\000\005\377\010\200u\210C\210t\220\3771\220A\330\010\016\210n\377\230B\230b\240\004\240C\377\240q\320(8\270\002\270\377\"\270D\300\016\310a\310\377s\320RU\320UV\330\377\014\031\230\036\240q\250\001\377\330\014\024\220L\240\001\240\377\021\340\014\022\220.\240\002\377\240\"\240D\250\003\2501\377\250G\2602\260Q\330\020\177\036\230e\2401\240A\006\000\377\320\036/\250~\270R\270\377{\310!\3108\320S^\377\320^_\320_`\340\020\377\026\220g\230R\230{\250\377!\2504\250z\270\034\300\3762\000!\240\021\330\020\033\230\3771\230F\240!\340\020\023\377\220;\230a\230s\240#\377\240Q\330\024\031\230\024\230\377Q\230a\340\014\017\210s\177\220!\2207\230#\230c\000\374}\004k\001d\240!\2401\340\377\t\016\210c\220\024\220Q\373\220a\n\301\004\013\2108\220\0011";
    PyObject *data = __Pyx_DecompressString_LZSS(cstring, 714, 949);
...
static const char bytes[] = "?Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the \047annotation_typing\047 directive to False.add_notesrc/matching_engine.pyx__Pyx_PyDict_NextRef__annotate____func____main____module____name____qualname____test___is_coroutineasyncio.coroutinesbest_pricecline_in_tracebackitemsmaker_ordermatch_order_cmatched_qtymatching_engineorder_idpoppricequantityqueueremaining_qtyresting_bookresting_pricessetdefaultsidetradesvaluesBS\200\001\360\026\000\005\047\240a\330\004$\240A\340\004\027\220q\360\010\000\005\010\200u\210C\210t\2201\220A\330\010\016\210n\230B\230b\240\004\240C\240q\320(8\270\002\270\"\270D\300\016\310a\310s\320RU\320UV\330\014\031\230\036\240q\250\001\330\014\024\220L\240\001\240\021\340\014\022\220.\240\002\240\"\240D\250\003\2501\250G\2602\260Q\330\020\036\230e\2401\240A\330\020\036\320\036/\250~\270R\270{\310!\3108\320S^\320^_\320_`\340\020\026\220g\230R\230{\250!\2504\250z\270\034\300Q\330\020!\240\021\330\020\033\2301\230F\240!\340\020\023\220;\230a\230s\240#\240Q\330\024\031\230\024\230Q\230a\340\014\017\210s\220!\2207\230#\230Q\330\020\024\220L\240\001\240\021\330\020\036\230d\240!\2401\340\t\016\210c\220\024\220Q\220a\330\010\016\210n\230B\230b\240\004\240C\240q\320(8\270\002\270\"\270D\300\016\310a\310s\320RU\320UV\330\014\031\230\036\240q\250\001\330\014\024\220L\240\001\240\021\340\014\022\220.\240\002\240\"\240D\250\003\2501\250G\2602\260Q\330\020\036\230e\2401\240A\330\020\036\320\036/\250~\270R\270{\310!\3108\320S^\320^_\320_`\340\020\026\220g\230R\230{\250!\2504\250z\270\034\300Q\330\020!\240\021\330\020\033\2301\230F\240!\340\020\023\220;\230a\230s\240#\240Q\330\024\031\230\024\230Q\230a\340\014\017\210s\220!\2207\230#\230Q\330\020\024\220L\240\001\240\021\330\020\036\230d\240!\2401\340\004\013\2108\2201";
    PyObject *data = NULL;
    #define __Pyx_DecompressString_UNUSED
    #define __Pyx_DecompressString_LZSS_UNUSED
    #endif
    ...
    for (int i = 33; i < 36; i++) {
      Py_ssize_t bytes_length = bytes_length_index[i-33].length;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {6, 0, 0, 12, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 4};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_order_id, __pyx_mstate->__pyx_n_u_price, __pyx_mstate->__pyx_n_u_quantity, __pyx_mstate->__pyx_n_u_side, __pyx_mstate->__pyx_n_u_resting_prices, __pyx_mstate->__pyx_n_u_resting_book, __pyx_mstate->__pyx_n_u_remaining_qty, __pyx_mstate->__pyx_n_u_matched_qty, __pyx_mstate->__pyx_n_u_best_price, __pyx_mstate->__pyx_n_u_trades, __pyx_mstate->__pyx_n_u_queue, __pyx_mstate->__pyx_n_u_maker_order};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_src_matching_engine_pyx, __pyx_mstate->__pyx_n_u_match_order_c, __pyx_mstate->__pyx_kp_b_iso88591_a_A_q_uCt1A_nBb_Cq_8_D_asRUUV_q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
...
/* CIntFromPy */
static char __Pyx_LargePyLong___Pyx_PyLong_As_char(PyObject *x);
static char __Pyx_raise_neg_overflow___Pyx_PyLong_As_char(void) {
    const char* type_name = "char";
    PyErr_Format(PyExc_OverflowError,
        "can't convert negative value to %.200s", type_name);
    return (char) -1;
}
static char __Pyx_raise_overflow___Pyx_PyLong_As_char(void) {
    const char* type_name = "char";
    PyErr_Format(PyExc_OverflowError,
        "value too large to convert to %.200s", type_name);
    return (char) -1;
}
static CYTHON_INLINE char __Pyx_PyULong___Pyx_PyLong_As_char(PyObject *x) {
    const int is_unsigned = 1;
#if CYTHON_USE_PYLONG_INTERNALS
    {
        const digit* digits = __Pyx_PyLong_Digits(x);
        const Py_ssize_t size = __Pyx_PyLong_DigitCount(x);
        if (size == 2 && (8 * sizeof(char) > 1 * PyLong_SHIFT)) {
            if ((8 * sizeof(unsigned long) > 2 * PyLong_SHIFT)) {
        ...
        if (size == 3 && (8 * sizeof(char) > 2 * PyLong_SHIFT)) {
            if ((8 * sizeof(unsigned long) > 3 * PyLong_SHIFT)) {
        ...
        if (size == 4 && (8 * sizeof(char) > 3 * PyLong_SHIFT)) {
            if ((8 * sizeof(unsigned long) > 4 * PyLong_SHIFT)) {
    ...
    return __Pyx_LargePyLong___Pyx_PyLong_As_char(x);
raise_neg_overflow:
    return __Pyx_raise_neg_overflow___Pyx_PyLong_As_char();
raise_overflow:
    return __Pyx_raise_overflow___Pyx_PyLong_As_char();
}
static CYTHON_INLINE char __Pyx_PySLong___Pyx_PyLong_As_char(PyObject *x) {
    const int is_unsigned = 0;
#if CYTHON_USE_PYLONG_INTERNALS
    if (__Pyx_PyLong_IsNeg(x)) {
        const Py_ssize_t size = __Pyx_PyLong_DigitCount(x);
        ...
        if (size == 2 && (8 * sizeof(char) > 1 * PyLong_SHIFT)) {
            if ((8 * sizeof(long) > 2 * PyLong_SHIFT)) {
                long ival = - (long) (((((unsigned long)digits[1]) << PyLong_SHIFT) | (unsigned long)digits[0]));
                __PYX_VERIFY_RETURN_INT(char, long, ival)
    ...
    if ((sizeof(char) <= sizeof(int)) && (sizeof(int) < sizeof(long))) {
        __PYX_VERIFY_RETURN_INT_EXC(char, int, PyLong_AsInt(x))
    } else
    #endif
...
static CYTHON_INLINE char __Pyx_PyLong___Pyx_PyLong_As_char(PyObject *x) {
#ifdef __Pyx_HAS_GCC_DIAGNOSTIC
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wconversion"
#endif
...
#pragma GCC diagnostic pop
    ...
    if (is_unsigned) {
        ...
        #endif
        {
            return __Pyx_PyULong___Pyx_PyLong_As_char(x);
        }
    } else {
        #if CYTHON_USE_PYLONG_INTERNALS
        if (__Pyx_PyLong_IsCompact(x)) {
        ...
        #endif
        {
            return __Pyx_PySLong___Pyx_PyLong_As_char(x);
        }
    }
#if CYTHON_USE_PYLONG_INTERNALS
raise_neg_overflow:
...
static char __Pyx_NonPyLong___Pyx_PyLong_As_char(PyObject *x) {
    char val;
    PyObject *tmp = __Pyx_PyNumber_Long(x);
...
static CYTHON_INLINE char __Pyx_PyLong_As_char(PyObject *x) {
    if (likely(PyLong_Check(x))) {
        return __Pyx_PyLong___Pyx_PyLong_As_char(x);
    } else {
        return __Pyx_NonPyLong___Pyx_PyLong_As_char(x);
    }
}
